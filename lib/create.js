...
const create = function create(...args) {
  ...
  spawn('cp', '-r', path.join(templatedirectory, path.sep), projectdirectory);
  spawn('cp', '-r', path.join(supplementsdirectory, 'icons', path.sep), projectdirectory);
  ...
  spawn('npm', '--prefix', projectdirectory, 'install', 'https://github.com/kamalasaurus/mithril.js/tarball/next');
